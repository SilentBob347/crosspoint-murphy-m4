...
#error \
    "FreeInk: no device selected. Pass at least one -DFREEINK_DEVICE_<NAME> (X4, X3, X4PRO, M5, MURPHY, DELINK, LILYGO, M5PAPER, STICKY, MURPHY_M4) in your build env — see platformio.sample.ini."
#endif
...
#define FREEINK_MCU_S3                                                                             \
  (FREEINK_DEVICE_M5 || FREEINK_DEVICE_MURPHY || FREEINK_DEVICE_DELINK || FREEINK_DEVICE_LILYGO || \
   FREEINK_DEVICE_STICKY || FREEINK_DEVICE_X4PRO || FREEINK_DEVICE_MURPHY_M4)
...
#define FREEINK_CAP_TOUCH                                                                               \
  (FREEINK_DEVICE_MURPHY || FREEINK_DEVICE_LILYGO || FREEINK_DEVICE_M5PAPER || FREEINK_DEVICE_STICKY || \
   FREEINK_DEVICE_X4PRO || FREEINK_DEVICE_MURPHY_M4)
#endif
...
#define FREEINK_SD_SDMMC (FREEINK_DEVICE_DELINK || FREEINK_DEVICE_X4PRO || FREEINK_DEVICE_MURPHY_M4)
#endif
...
enum class TouchController : uint8_t { None, Chsc6x, Gt911, Ft6336u };
